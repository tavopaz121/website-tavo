...
import sectionScrum from "~/assets/imgs/clasesonetoone/section_scrum.png";
   ...
   <div className="bg-gray-900">
          ...
          <div className="max-w-3xl mx-auto text-center pb-10 md:pb-16">
            ...
            <div className="flex justify-center">
              ...
              <div data-aos="fade-up" data-aos-delay="600">
                <a className="btn text-white bg-gray-700 hover:bg-gray-800 lg:w-full w-auto ml-4" href="#0">Learn more</a>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up">
              ...
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                ...
                <path className="stroke-current text-pink-300" strokeWidth="2" strokeLinecap="square" d="M21 23h22v18H21z" fill="none" fillRule="evenodd" />
                <path className="stroke-current text-pink-100" d="M26 28h12M26 32h12M26 36h5" strokeWidth="2" strokeLinecap="square" />
              </svg>
              <h4 className="h4 mb-2 text-white"><span className="text-gray-400">1</span>. Personas y justicias</h4>
              <p className="text-lg text-gray-400 text-center">Se manifiesta cuando las personas colaboran en entornos inclusivos, garantizando la accesibilidad, la diversidad de ideas y la equidad en el desarrollo de soluciones tecnológicas para el beneficio colectivo.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                ...
                <g fill="none" fillRule="evenodd">
                  <path className="stroke-current text-pink-300" d="M40 22a2 2 0 012 2v16a2 2 0 01-2 2H24a2 2 0 01-2-2V24a2 2 0 012-2" strokeWidth="2" strokeLinecap="square" />
                  <path className="stroke-current text-pink-100" strokeWidth="2" strokeLinecap="square" d="M36 32l-4-3-4 3V22h8z" />
                </g>
              </svg>
              <h4 className="h4 mb-2 text-white"><span className="text-gray-400">2</span>. Simplicidad y lotes pequeños</h4>
              <p className="text-lg text-gray-400 text-center">Descomponer el trabajo en secciones pequeñas y progresivas simplifica la complejidad y brinda la oportunidad de iterar, corregir y mejorar con agilidad, permitiendo un desarrollo más preciso, eficiente y robusto del software.</p>
            </div>
    ...
    <article className="max-w-6xl relative mx-auto px-4 flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 bg-gray-800 p-8">
            ...
            <p className="text-lg text-gray-400 mb-2">Se capacita individualmente porque cada estudiante es diferente, y  brinda la oportunidad de un aprendizaje más eficaz, adaptado y enfocado en las necesidades particulares de cada persona.</p>
            <h4 className="h4 text-white">Capacitación en equipo</h4>
            <p className="text-lg text-gray-400 ">Fortalece la dinámica grupal y el rendimiento colectivo, generando un impacto positivo en el funcionamiento general de una organización y también porque 1 + 1 = 3 o 5.</p>
