...
import picturejs from "~/assets/imgs/clasesonetoone/picture-js.png"; 
...
export default function Mentorias() {
  ...
  return (
    <div className="bg-gray-900">
          ...
          <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto text-center pb-10 md:pb-16">
              ...
              >
                ...
                proyectos reales, no pierdas tu tiempo. Devs de calidad para
      ...
      {/* Mentorias / Cursos  */}
      <section>
        <div className=" max-w-6xl grid grid-cols-12 gap-6 px-4 mx-auto">
          {/* Cards a */}
                ...
                <div className="flex items-center py-2">
                  <div className="text-center">
                    ...
                    <div className="text-justify text-white">
                      <p>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas adipisci ipsam id alias unde aliquam minus et accusamus assumenda harum expedita saepe necessitatibus rerum in, dicta libero nemo deleniti inventore?
                      </p>
                    </div>
                    <a
                      className="btn text-white bg-gray-700 hover:bg-gray-800 lg:w-full w-auto mx-auto"
                      href="#principios"
                    >
                      Información
                    </a>
              ...
              <div className="flex flex-wrap ">
                ...
                <div className="flex items-center py-2">
                  <div className="text-center">
                    ...
                    <div className="text-center lg:text-justify text-white pb-5">
                      <p>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas adipisci ipsam id alias unde aliquam minus et accusamus assumenda harum expedita saepe necessitatibus rerum in, dicta libero nemo deleniti inventore?
                      </p>
                    </div>
