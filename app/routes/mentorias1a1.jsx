                  ...
                  <div className="text-center">
                    ...
                    <div className="text-justify text-white pb-5">
                      <p>
                        ...
                        elit. Voluptas adipisci ipsam id alias unde aliquam
                        minus et accusamus assumenda harum expedita saepe
                        necessitatibus rerum in, dicta libero nemo deleniti
                        inventore?
                      </p>
                    </div>
              ...
              <div className="xl:flex xl:flex-wrap tex-justify items-center ">
                ...
                <div className="w-full xl:w-2/3 text-center text-white pb-5">
                  ...
                  <p className="text-justify">
                    ...
                    neque eos nulla laudantium praesentium velit. Accusamus
                    saepe minus sit dicta debitis eligendi.
                  </p>
