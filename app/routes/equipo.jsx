...
<section>
  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          {/* Section header */}
          <div className="max-w-4xl mx-auto text-center pb-10 md:pb-16">
            <h1 className="mb-4 lg:text-7xl md:text-6xl text-white text-4xl font-heading" data-aos="fade-up">Máximo <span className="font-serif italic">Rendimiento</span></h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">Imagina un enfoque que maximice la colaboración, acelere la entrega
...
<div className="m-20">
      ...
      <div className="absolute inset-0">
        <img className="w-full h-full object-cover" src={team} width={1440} height={394} priority alt="About" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        <div className="pt-20 pb-20">
          ...
          <span className="font-serif italic">equipo</span>
            ...
            <p className="text-xl text-gray-300 pt-5" data-aos="fade-up" data-aos-delay="200">Permitimos a los desarrolladores crear cosas increibles</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-wrap  gap-y-12 mt-10 relative px-8 items-center">
          ...
          <div className="grid flex-auto mx-auto px-8 sm:px-6 relative md:min-w-[300px] mb-12">
            {/* Section content */}
            <div className="flex flex-wrap md:max-w-none items-center space-y-8 md:space-y-0">
              {/* Creatives cards */}
              <div className="w-full " data-aos-id-cards>
