...
export default function Features() {
  ...
  return (
    <section>
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 bg-slate-900">
        {/* Illustration */}
        <div
          ...
          <div>
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              >
                ...
                <h3 className="h3 bg-clip-text [-webkit-background-clip:text] text-transparent bg-gradient-to-r from-white via-slate-200 to-slate-200/60 pb-3">
