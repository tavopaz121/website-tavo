...
import Metodo from "../../HomePage/Metodo";
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full lg:w-2/3 xl:w-1/2 px-4 mb-16 lg:mb-0">
              <div className="xs:max-w-xs sm:max-w-lg lg:max-w-xl">
                ...
                <a
                  className="relative group inline-block py-4 px-6 text-white font-semibold bg-gray-700 rounded-md overflow-hidden"
                  href="/nosotros"
                >
                  <div className="absolute top-0 right-full w-full h-full bg-pink-500 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
