import type { PropsSvg } from "./Sgv.d";
import SvgContainer from "./SvgContainer";

export default function SvgAppWeb({ color, width, height, title }: PropsSvg) {
  return (
    <SvgContainer
      color={color}
      height={width}
    ...
    >
      <g>
        <g>
          <path
            d="M0,60.046v391.908h512V60.046H0z M496.378,100.306H127.903v15.622h368.476v320.406H15.622v-0.001V75.668h480.757V100.306z
			"
          />
        </g>
      </g>
      ...
      <g>
        <g>
          <path
            d="M40.031,140.106v271.818h111.695V140.106H40.031z M136.104,396.303H55.652V266.659
      ...
      <g>
        <g>
          <polygon
            points="176.134,140.106 176.134,267.814 368.085,267.814 368.085,252.192 191.755,252.192 191.755,155.728
      ...
      <g>
        <g>
          <path
            d="M461.744,262.405l-66.103-39.663c-7.122-4.272-16.195-3.157-22.069,2.717c-5.872,5.872-6.988,14.947-2.716,22.067
